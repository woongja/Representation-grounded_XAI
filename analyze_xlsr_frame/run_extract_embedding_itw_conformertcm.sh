...
################################################################################
# ITW Dataset Fine-tuned ConformerTCM SSL Embedding Extraction Script
#
# This script extracts embeddings from ITW dataset
# using fine-tuned ConformerTCM model (SSL frontend only) and saves them by label
#
# Usage:
#   bash run_extract_embedding_itw_conformertcm.sh
################################################################################
...
OUTPUT_DIR="/nvme3/wj/embeddings_itw_conformertcm/"
...
echo "================================================================================"
echo "ITW Dataset - Fine-tuned ConformerTCM SSL Embedding Extraction"
echo "================================================================================"
...
# Run extraction
python extract_embedding_itw_conformertcm.py \
