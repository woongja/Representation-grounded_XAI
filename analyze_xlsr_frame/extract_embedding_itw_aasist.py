"""
Extract and Save SSL Embeddings for ITW Dataset (Fine-tuned AASIST)
...
def main():
    parser = argparse.ArgumentParser(
        description="Extract and save SSL embeddings for ITW dataset using fine-tuned AASIST"
    )
    parser.add_argument(
        '--protocol_path',
        type=str,
    ...
    parser.add_argument(
        '--output_dir',
        type=str,
        default='/nvme3/wj/embeddings_itw_aasist/',
        help='Directory to save embeddings (default: /nvme3/wj/embeddings_itw_aasist/)'
    )
    parser.add_argument(
        '--device',
        type=str,
    ...
    print("="*80)
    print("ITW Dataset - Fine-tuned AASIST Embedding Extraction")
    print("="*80)
