"""
Extract and Save SSL Embeddings for ITW Dataset (Fine-tuned ConformerTCM)

This script extracts frame-level embeddings from the fine-tuned ConformerTCM model
(SSL frontend only) and saves them to disk for ITW dataset.
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Extract and save SSL embeddings for ITW dataset using fine-tuned ConformerTCM"
    )
    parser.add_argument(
        '--protocol_path',
        type=str,
    ...
    parser.add_argument(
        '--output_dir',
        type=str,
        default='/nvme3/wj/embeddings_itw_conformertcm/',
        help='Directory to save embeddings (default: /nvme3/wj/embeddings_itw_conformertcm/)'
    )
    parser.add_argument(
        '--device',
        type=str,
    ...
    print("="*80)
    print("ITW Dataset - Fine-tuned ConformerTCM Embedding Extraction")
    print("="*80)
