...
################################################################################
# Fine-tuned AASIST SSL Embedding Extraction Script
#
# This script extracts embeddings from ASVspoof 2019 LA dataset
# using fine-tuned AASIST model (SSL frontend only) and saves them by attack type
#
# Usage:
#   bash run_extract_embedding_finetuned.sh
################################################################################
...
OUTPUT_DIR="/nvme3/wj/embeddings_finetuned/"
...
echo "================================================================================"
echo "Fine-tuned AASIST SSL Embedding Extraction"
echo "================================================================================"
...
# Run extraction
python extract_embedding_finetuned.py \
