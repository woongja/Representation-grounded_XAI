...
#
# This script creates t-SNE visualizations of SSL embeddings
...
# Sampling parameters
MAX_FILES_PER_ATTACK=100    # Number of files to sample per attack type
...
echo "Max files per attack:   $MAX_FILES_PER_ATTACK"
...
echo "  - tsne_by_attack.png  (all attack types)"
echo "  - tsne_binary.png     (bonafide vs deepfake)"
echo ""
echo "================================================================================"
echo "✓ Done!"
echo "================================================================================"
