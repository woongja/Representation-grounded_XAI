...
MODEL_SAVE_PATH="/home/woongjae/ADD_LAB/Representation-grounded_XAI/out/xai_asv19_b.pth"
COMMENT="xai_model_a_baseline_no_xai_losses"

# ========================
# Training 실행
# ========================
OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES=MIG-8cdeef83-092c-5a8d-a748-452f299e1df0 python /home/woongjae/ADD_LAB/Representation-grounded_XAI/main.py \
